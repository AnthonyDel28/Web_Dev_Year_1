			...
			<div class="progression-blog-content">
				...
				<?php if ( 'post' == get_post_type() ) : ?>
					<ul class="progression-post-meta">
						<?php if (get_theme_mod( 'progression_studios_blog_meta_author_display', 'true') == 'true') : ?><li class="blog-meta-author-display"><?php echo esc_html__( 'By ', 'poker-dice-progression' )?><a href="<?php echo get_author_posts_url( get_the_author_meta( 'ID' ), get_the_author_meta( 'user_nicename' ) ); ?>"><?php the_author(); ?></a></li><?php endif; ?>

					
						<?php if (get_theme_mod( 'progression_studios_blog_meta_date_display', 'true') == 'true') : ?><li class="blog-meta-date-display"><?php the_time(get_option('date_format')); ?></li><?php endif; ?>
				...
				<div class="progression-studios-blog-single-excerpt">
					...
					<?php the_tags(  '<div class="tags-progression"><span>' .  esc_html__( 'Tags:', 'poker-dice-progression' ) . '</span>', ' ', '</div>' ); ?> 
					</div>
				<div class="clearfix-pro"></div>
			</div>
