...
?>
		<footer id="site-footer" class="<?php echo esc_attr( get_theme_mod('progression_studios_footer_width', 'progression-studios-footer-normal-width') ); ?> <?php echo esc_attr( get_theme_mod('progression_studios_footer_image_location_align') ); ?> <?php echo esc_attr( get_theme_mod('progression_studios_footer_nav_align') ); ?> <?php echo esc_attr( get_theme_mod('progression_studios_footer_copyright_location', 'footer-copyright-align-left') ); ?>">
			...
			<?php if ( get_theme_mod('progression_studios_footer_copyright', 'All Rights Reserved. Developed by Progression Studios') ) : ?>
	...
	<a href="#0" id="pro-scroll-top"><?php esc_html_e( 'Scroll to top', 'poker-dice-progression' ); ?></a>
