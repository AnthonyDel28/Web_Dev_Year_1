...
$cfg['Servers'][$i]['AllowNoPassword']	= true;   // true/false
$cfg['blowfish_secret']					= '`GfuUzov-Nsq6NwXx9{R#B4|f*oqjVF$' ;  // i.e. '$b~`lnkwm>^^jNUEE;(4xB$L\'b?."\'o9' 
...
$cfg['PmaAbsoluteUri'] 					= '/IEPSCF/wp/wp-content/plugins/wp-phpmyadmin-extension/lib/phpMyAdmin_3JaLPVOj7ykMRShTW2bnqwC/';			//used, if different directory by htaccess ; or parse_url($GLOBALS['PMA_PHP_SELF']);
