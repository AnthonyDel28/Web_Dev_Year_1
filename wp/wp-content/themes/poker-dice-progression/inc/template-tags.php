...
?>
	class="
		...
		<?php if(is_singular( 'elementor_library' )) : ?> progression-disable-header-per-page progression-disable-footer-per-page<?php endif; ?>
...
?>
	...
	<div class="width-container-pro optional-centered-area-on-mobile">
		...
		<div class="mobile-menu-icon-pro noselect"><i class="fa fa-bars"></i><?php if (get_theme_mod( 'progression_studios_mobile_menu_text') == 'on' ) : ?><span class="progression-mobile-menu-text"><?php echo esc_html__( 'Menu', 'poker-dice-progression' )?></span><?php endif; ?></div>
...
function progression_studios_show_pagination_links_pro()
{
    ...
    echo paginate_links( array(
            ...
            'total'     => $page_tot,
            'prev_next' => true,
				'prev_text'    => esc_html__('&lsaquo; Previous', 'poker-dice-progression'),
				'next_text'    => esc_html__('Next &rsaquo;', 'poker-dice-progression'),
            'end_size'  => 1,
            'mid_size'  => 2,
            'type'      => 'list'
        )
...
function progression_studios_infinite_content_nav_pro( $html_id ) {
	...
	if ( $wp_query->max_num_pages > 1 ) : ?>
		<div id="infinite-nav-pro-default" class="infinite-nav-pro">
			<div class="nav-previous"><?php next_posts_link( wp_kses( __('Load More <span><i class="fa fa-arrow-circle-down"></i></span>', 'poker-dice-progression' ) , TRUE) ); ?></div>
		</div>
	<?php endif;
}
endif;
